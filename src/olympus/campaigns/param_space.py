...
class ParameterSpace:
    ...
    def param_bounds(self):
        ...
        return [(param.low, param.high) for param in self if param.type in ['discrete', 'continuous']]
    ...
    def param_uppers(self):
        ...
        return np.array([param.high for param in self if param.type in ['discrete', 'continuous']])
