...
class PlotterSeaborn(AbstractPlotter):
    ...
    def _plot_traces(self, emulators, planners, measurements, file_name = None, show = False, *args, **kwargs):
    ...
    def _plot_traces_regret(self, emulators, planners, measurements, file_name = None, show = False, *args, **kwargs):
    ...
    def _plot_traces_rank(self, emulators, planners, measurements, file_name = None, show = False, *args, **kwargs):
    ...
    def _plot_traces_fraction_top_k(self, emulators, planners, measurements, threshold, is_percent, file_name = None, show = False, *args, **kwargs):
    ...
    def _plot_num_evals_top_k(self, emulators, planners, measurements, threshold, is_percent, file_name = None, show = False, *args, **kwargs):
