...
@pytest.mark.parametrize("batches, boosted, parallel, sampling_strategies",
						 [(1, True, True, 1),
						  (1, True, True, 2),
						  (1, False, True, 2),
						  (1, False, False, 2)])
def test_planner_ask_tell(two_param_space, batches, boosted, parallel, sampling_strategies):
	planner = Phoenics(batches=batches, boosted=boosted, parallel=parallel, sampling_strategies=sampling_strategies)
