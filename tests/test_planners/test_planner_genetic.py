...
@pytest.mark.parametrize("pop_size, cx_prob, mut_prob, mate_args, mutate_args, select_args",
                         [(10, 0.5, 0.3,
                           {'function': tools.cxTwoPoint},
                           {'function': tools.mutGaussian, 'mu': 0, 'sigma': 0.2, 'indpb': 0.2},
                          ...
                          (16, 0.4, 0.2,
                           ...
                           {'function': tools.mutGaussian, 'mu': 0, 'sigma': 0.2, 'indpb': 0.5},
